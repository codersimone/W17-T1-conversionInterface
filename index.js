...
//получить строку введенную пользователем - done
//проверить на:
//лишние пробелы
//отсутствие больших букв в фамилии, имени, отчестве или сразу все сделать lowercase
//писать все 3 типа данных с заглавной буквы
//сделать split(' '), чтобы получить массив из трёх слов - let result = userFullName.split(' ');